      ...
      <Form ref="addForm" :model="addForm" :rules="ruleValidate" :label-width="120">
        <Col span="12">
          <FormItem label="名称" prop="title">
            <Input v-model="addForm.title" placeholder="名称"></Input>
          </FormItem>
          <FormItem label="类型" prop="type">
            <Input v-model="addForm.type" placeholder="类型"></Input>
          </FormItem>
        </Col>
        <Col span="12">
        <FormItem label="键值" prop="value">
            <Input v-model="addForm.value" placeholder="键值"></Input>
          </FormItem>
          <FormItem label="排序" prop="orderLine">
            <Input v-model="addForm.orderLine" placeholder="排序"></Input>
          </FormItem>
        </Col>
        <Col span="24">
